...
<html lang="en">
  ...
  <div class="container-fluid" id='navbar_content'>
    <a class="navbar-brand" id='navbar_logo' href="./index.php"><span style="color: darkblue;"><b>Learn</span>iverse</b></a>
    ...
    <button type="button" class='nav_but btn' id='show_menu'>
      ...
      <div class="navbar-collapse hide_menu" id="navbarResponsive">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li>
            <a class="nav-link" href="./select_teacher.php">Teachers</a>
          </li>
          <li class="nav-item">
          ...
          <?php if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] == 'YES!') {
                  if (isset($_SESSION['teacher']) && $_SESSION['teacher'] == 'yes'){ ?>
                    <li class="nav-item">
                      <a class="nav-link" href="./teachers">Schedule</a>
                    </li>
                    <?php }}
            ?>
          <?php if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] == 'YES!') {
                  if (isset($_SESSION['super']) && $_SESSION['super'] == 'yes'){ ?>
                    ...
                    <li>
                      <a class="nav-link" href="./admin/employees.php">Tutor Access</a>
                    </li>
                 <?php }
            ?>
              <li class="nav-item">
